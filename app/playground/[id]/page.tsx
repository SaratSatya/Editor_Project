...
const MainPlaygroundPage = () => {
        ...
        const updateFileContent=(items:any[])=>
          ...
          items.map((item)=>{
            if("folderName" in item){
              return {...item,tems:updateFileContent(item.items)};
            }else if(
    ...
    if(error){
      return(
        <div className='flex flex-col items-center jusitfy-center h-[calc(100vh-4rem)] p-4'>
    ...
    if(!templateData){
      return(
        <div className='flex flex-col items-center justify-cneter h-[calc(100vh-4rem)] p-4'>
